...
![image alt text](./img_metadata/image_0.png)
...
![image alt text](./img_metadata/image_1.png)

![image alt text](./img_metadata/image_2.png)
...
![image alt text](./img_metadata/image_3.png)
...
![image alt text](./img_metadata/image_4.png)
...
![image alt text](./img_metadata/image_5.png)
...
![image alt text](./img_metadata/image_6.png)
...
![image alt text](./img_metadata/image_7.png)
...
![image alt text](./img_metadata/image_8.png)
...
![image alt text](./img_metadata/image_9.png)
...
![image alt text](./img_metadata/image_10.png)

Case I:

![image alt text](./img_metadata/image_11.png)

Case II:

![image alt text](./img_metadata/image_12.png)
...
![image alt text](./img_metadata/image_13.png)
...
![image alt text](./img_metadata/image_14.png)
...
![image alt text](./img_metadata/image_15.png)
...
![image alt text](./img_metadata/image_16.png)

**A Thread that will increment the counter 10,000 times:**

![image alt text](./img_metadata/image_17.png)

**The code from within this application's main method:**

![image alt text](./img_metadata/image_18.png)
...
![image alt text](./img_metadata/image_19.png)

![image alt text](./img_metadata/image_20.png)

In reality, even getAndIncrement() takes several steps. This implementation uses CAS stands for Compare And Swap. 

![image alt text](./img_metadata/image_21.png)
...
![image alt text](./img_metadata/image_22.png)

**Equivalent code using the java.util.concurrent.locks package.**

![image alt text](./img_metadata/image_23.png)
...
![image alt text](./img_metadata/image_24.png)
...
![image alt text](./img_metadata/image_25.png)
...
![image alt text](./img_metadata/image_27.png)![image alt text](./img_metadata/image_28.png)
...
![image alt text](./img_metadata/image_29.png)

![image alt text](./img_metadata/image_30.png)![image alt text](./img_metadata/image_31.png)
...
![image alt text](./img_metadata/image_32.png)

![image alt text](./img_metadata/image_33.png)
...
![image alt text](./img_metadata/image_34.png)
...
Before calling await on a Condition, a thread must first acquire a Lock on the object used to produce the Condition. It is possible that the awaiting thread may be interrupted and you must handle the possible InterruptedException.
 ...
 ![image alt text](./img_metadata/image_35.png)
...
![image alt text](./img_metadata/image_36.png)
...
![image alt text](./img_metadata/image_37.png)
...
![image alt text](./img_metadata/image_38.png)
...
![image alt text](./img_metadata/image_39.png)
...
![image alt text](./img_metadata/image_40.png)
...
![image alt text](./img_metadata/image_41.png)
...
![image alt text](./img_metadata/image_42.png)
...
![image alt text](./img_metadata/image_43.png)

![image alt text](./img_metadata/image_44.png)
...
![image alt text](./img_metadata/image_45.png)
...
![image alt text](./img_metadata/image_46.png)
...
![image alt text](./img_metadata/image_47.png)
...
![image alt text](./img_metadata/image_48.png)
...
![image alt text](./img_metadata/image_49.png)

![image alt text](./img_metadata/image_50.png)
...
![image alt text](./img_metadata/image_51.png)

Executor implementation that would use a new thread for each task:

![image alt text](./img_metadata/image_52.png)

Using an Executor implementation

![image alt text](./img_metadata/image_53.png)
...
![image alt text](./img_metadata/image_54.png)
...
![image alt text](./img_metadata/image_55.png)
...
![image alt text](./img_metadata/image_56.png)
...
![image alt text](./img_metadata/image_57.png)
...
![image alt text](./img_metadata/image_58.png)
...
![image alt text](./img_metadata/image_59.png)

**Single Thread Pools**

![image alt text](./img_metadata/image_60.png)
...
![image alt text](./img_metadata/image_62.png)
...
![image alt text](./img_metadata/image_63.png)
...
![image alt text](./img_metadata/image_64.png)
...
![image alt text](./img_metadata/image_65.png)
...
![image alt text](./img_metadata/image_66.png)
...
![image alt text](./img_metadata/image_67.png)
...
![image alt text](./img_metadata/image_68.png)
...
![image alt text](./img_metadata/image_69.png)

**The following example will initialize an array to contain random values.**

![image alt text](./img_metadata/image_70.png)![image alt text](./img_metadata/image_71.png)
...
![image alt text](./img_metadata/image_74.png)

**Eg: Find position of greatest element in an array; return first occurrence incase of duplicate elements**

![image alt text](./img_metadata/image_75.png)

![image alt text](./img_metadata/image_76.png)
...
![image alt text](./img_metadata/image_77.png)![image alt text](./img_metadata/image_78.png)
...
* **Performance benefits might only be seen with a certain number of CPUs** A task might run on one CPU in 5 seconds, on two CPUs in 6 seconds, and on four CPUs in 3.5 seconds.
...
![image alt text](./img_metadata/image_79.png)![image alt text](./img_metadata/image_80.png)
